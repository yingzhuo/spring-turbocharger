...
/**
 * @author 应卓
 * @see com.github.yingzhuo.turbocharger.util.crypto.keystore.KeyStoreHelper
 * @since 3.5.0
 */
public abstract class AbstractPkcs12LoadingAlgorithmFactoryBean implements FactoryBean<Algorithm>, InitializingBean, DisposableBean {
	...
	public void afterPropertiesSet() {
		keyStore = KeyStoreHelper.loadKeyStore(ResourceUtils.loadResourceAsInputStream(location), KeyStoreFormat.PKCS12, storepass);
	}
