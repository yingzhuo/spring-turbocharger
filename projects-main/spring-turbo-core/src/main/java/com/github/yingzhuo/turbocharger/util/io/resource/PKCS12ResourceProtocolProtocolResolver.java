...
/**
 * @author 应卓
 * @see KeyStoreResource
 * @see JKSResourceProtocolProtocolResolver
 * @since 3.5.0
 */
public class PKCS12ResourceProtocolProtocolResolver implements ProtocolResolver {

	private static final Pattern PATTERN = Pattern.compile("^pkcs12:(.*?)\\?storepass=(.*)$");

	/**
	 * 默认构造方法
	 */
	public PKCS12ResourceProtocolProtocolResolver() {
		super();
	}
